...
The main objective of the lab is to provide a controlled and isolated environment for safely conducting cybersecurity activities, including the use of security tools, network scanning, reconnaissance, vulnerability assessment, and other penetration-testing techniques. This setup allows these activities to be performed consistently and repeatedly without affecting real-world systems.

The laboratory operates on a private virtual network, making it possible to add more virtual machines in the future. These machines can serve as targets for authorized security testing and practical cybersecurity exercises.
---
